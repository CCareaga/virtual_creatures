...
parser.add_argument('--checkpoint', type=str, help='stored creature pickle file', default='')
...
if args.task == 'following':
    test_following(creature, record=args.record, out_file=args.output_path)
else:
    test_walking(creature, record=args.record, out_file=args.output_path)
